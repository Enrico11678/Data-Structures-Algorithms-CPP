...
public:
  ...
  virtual void Clear() = 0; // Pure virtual function, must be implemented by concrete containers
...
public:
  ...
  virtual void Resize(ulong) = 0; // Pure virtual function, must be implemented by concrete containers
